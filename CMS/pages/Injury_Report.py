...
#st.sidebar.image('assets/imgs/ArmyLogo.png', caption=None,  use_column_width=True, clamp=True, channels="RGB", output_format="PNG")
...
with forms :
   ...
   # with p1:
       ...
       c1.checkbox("Hypothermia")
       c2.checkbox("Hyperthermia")
   ...
   # with p2:
       ...
       c4.selectbox("Dressing",("Hemostatic","Pressure","Other"))
       c5.selectbox("TQ",("Extremity","Junctional","Truncal"))
       c3.checkbox("ET Tube")
       c1.checkbox("O2")
       c2.checkbox("Needle -D")
       c3.checkbox("Chest-Tube")
       c1.checkbox("Tourniquet")
       c2.checkbox("Survival Blanket")
...
#st.button(label="Add new injury", type="primary", disabled=False, use_container_width=0)
   ...
   # with p2:
       ...
       c3.checkbox("ET Tube")
       c1.checkbox("O2")
       c1.checkbox("Needle -D")
       c3.checkbox("Chest-Tube")
       c3.checkbox("Tourniquet")
       c1.checkbox("Survival Blanket")
     ...
     selectCanvas = st.radio("CALL",
                            options = ('REGIMENT AID POST', 'REGIMENT SURGERY CENTER', 'ZONAL HOSPITAL'),
                            horizontal = True,
                            label_visibility = 'hidden')
